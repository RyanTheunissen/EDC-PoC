...
### Get Contract ID
curl -X GET "http://localhost:29193/management/v3/contractnegotiations/c8e25dbb-d3cd-484c-90e6-7308ffed3691" -H "X-Api-Key: password" -H "Content-Type: application/json" -s | jq
